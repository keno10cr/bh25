export const PROPOSAL_COPY = {
  en: {
    ...
    contactWeb: "www.blessedhouse.info",
    contactLocation: "Puerto Viejo, Talamanca, Costa Rica",
    brandLine: "Villas Blessed House",
    printHeader: "Private Proposal",
  },
  es: {
