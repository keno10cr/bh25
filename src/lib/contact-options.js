...
export const CONTACT_VILLAS = [
  ...
  { id: 9, name: "Villa #9 Mono Cariblanco", maxPeople: 3, slug: "villa-9-mono-cariblanco" },
  { id: 10, name: "Villa #10 Mono Ardilla", maxPeople: 4, slug: "villa-10-mono-ardilla" },
  { id: 11, name: "Villa #11 Lapa Roja", maxPeople: 6, slug: "villa-11-lapa-roja" },
...
export const SUBJECT_OPTIONS = [
  {
    value: "booking",
    icon: "/icons/villas.svg",
    labelKey: "booking",
  },
  {
    value: "activities",
    icon: "/icons/activity.svg",
    labelKey: "activityInquiry",
  },
  {
    value: "general",
