...
const villas = [
  {
    ...
    image: "/placeholder.svg?key=obv1",
  },
  {
    id: 2,
    ...
    image: "/placeholder.svg?key=jrb1",
  },
  {
    id: 3,
    ...
    image: "/placeholder.svg?key=svp1",
  },
  {
    id: 4,
    ...
    features: ["Private Pool", "Beach Access", "Chef Kitchen", "WiFi", "AC", "Entertainment Area"],
    image: "/placeholder.svg?key=cpv1",
  },
  {
    id: 5,
    ...
    bedrooms: 2,
    bathrooms: 2,
    description: "Private retreat away from the hustle. Surrounded by exotic plants and peaceful ambiance.",
    features: ["Privacy Gate", "Garden", "Outdoor Shower", "WiFi", "AC", "Hammocks"],
    image: "/placeholder.svg?key=sp1",
  },
  {
    id: 6,
